...
//    ool_write(PMU_REG_GATE_CTRL_1, (ool_read(PMU_REG_GATE_CTRL_1)|0x08));//bit3 for cache
    ...
    system_set_tx_power(RF_TX_POWER_POS_6dBm); // RF_TX_POWER_POS_4dBm,    RF_TX_POWER_0dBm,

#if ENABLE_SYSTEM_PROTECTION_IN_LVD == 1
    pmu_lvd_en(0, LVD_2_3_V, 0);
...
void pmu_ft_trim_config(struct_FT_Param_t *FT_Param)
{
    ...
    {
        if ((FT_Param->Param.V6.TxChannelParam[0].Modem_VCO_GAU != 0) && (FT_Param->Param.V6.TxChannelParam[0].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V6.TxChannelParam[5].Modem_VCO_GAU != 0) && (FT_Param->Param.V6.TxChannelParam[5].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V6.TxChannelParam[9].Modem_VCO_GAU != 0) && (FT_Param->Param.V6.TxChannelParam[9].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V6.TxChannelParam[13].Modem_VCO_GAU != 0) && (FT_Param->Param.V6.TxChannelParam[13].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V6.TxChannelParam[19].Modem_VCO_GAU != 0) && (FT_Param->Param.V6.TxChannelParam[19].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V6.TxChannelParam[21].Modem_VCO_GAU != 0) && (FT_Param->Param.V6.TxChannelParam[21].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V6.TxChannelParam[25].Modem_VCO_GAU != 0) && (FT_Param->Param.V6.TxChannelParam[25].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V6.TxChannelParam[29].Modem_VCO_GAU != 0) && (FT_Param->Param.V6.TxChannelParam[29].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V6.TxChannelParam[33].Modem_VCO_GAU != 0) && (FT_Param->Param.V6.TxChannelParam[33].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V6.TxChannelParam[39].Modem_VCO_GAU != 0) && (FT_Param->Param.V6.TxChannelParam[39].Modem_MODDAC != 0))
        {
    ...
    {
        if ((FT_Param->Param.V7.TxChannelParam[0].Modem_VCO_GAU != 0) && (FT_Param->Param.V7.TxChannelParam[0].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V7.TxChannelParam[1].Modem_VCO_GAU != 0) && (FT_Param->Param.V7.TxChannelParam[1].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V7.TxChannelParam[2].Modem_VCO_GAU != 0) && (FT_Param->Param.V7.TxChannelParam[2].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V7.TxChannelParam[3].Modem_VCO_GAU != 0) && (FT_Param->Param.V7.TxChannelParam[3].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V7.TxChannelParam[4].Modem_VCO_GAU != 0) && (FT_Param->Param.V7.TxChannelParam[4].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V7.TxChannelParam[5].Modem_VCO_GAU != 0) && (FT_Param->Param.V7.TxChannelParam[5].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V7.TxChannelParam[6].Modem_VCO_GAU != 0) && (FT_Param->Param.V7.TxChannelParam[6].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V7.TxChannelParam[7].Modem_VCO_GAU != 0) && (FT_Param->Param.V7.TxChannelParam[7].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V7.TxChannelParam[8].Modem_VCO_GAU != 0) && (FT_Param->Param.V7.TxChannelParam[8].Modem_MODDAC != 0))
        {
        ...
        if ((FT_Param->Param.V7.TxChannelParam[9].Modem_VCO_GAU != 0) && (FT_Param->Param.V7.TxChannelParam[9].Modem_MODDAC != 0))
        {
...
__attribute__((section("ram_code"))) void pmu_isr(void)
{
    ...
    if (state & PMU_GPIO_XOR_INT_STATUS)
    {
        ...
        /*
          pin_value = ool_read32(PMU_REG_PORTC_LAST_STATUS);
    //LOG_DBG(NULL, "pmu gpio value is %08x.\r\n", pin_value);
    pmu_gpio_isr(pin_value);
    ool_write32(PMU_REG_PORTC_LAST_STATUS, pin_value);

          pin_value = ool_read32(PMU_REG_PORTD_LAST_STATUS);
    //LOG_DBG(NULL, "pmu gpio value is %08x.\r\n", pin_value);
    pmu_gpio_isr(pin_value);
    ool_write32(PMU_REG_PORTD_LAST_STATUS, pin_value);
        */
    }
#if ENABLE_SYSTEM_PROTECTION_IN_LVD == 1
