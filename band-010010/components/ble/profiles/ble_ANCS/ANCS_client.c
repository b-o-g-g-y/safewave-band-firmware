    ...
    while(i < len)
    {
        switch(p_data[i++])
        {
            case NTF_ATT_ID_APPLE:
                ...
                i+=2;
						co_printf("ancsID: ");show_string(p_data + i,data_len,1);
								findAppID(p_data+i,data_len);
                ...
                if( memcmp(p_data+i,"com.tencent.xin",strlen("com.tencent.xin"))==0 )
                    ...
                    msg_type = MOBILE_SMS;
                else if( memcmp(p_data+i,"com.apple.mobilephone",strlen("com.apple.mobilephone"))==0 )//call
            ...
            case NTF_ATT_ID_POSITIVE_ACT:       //UTF-8
                data_len = *(uint16_t *)(p_data + i);
                //co_printf("NTF_POSITIVE_ACT,len:%d\r\n",data_len);
                i+=2;
            ...
            case NTF_ATT_ID_NEGATIVE_ACT:       //UTF-8
                data_len = *(uint16_t *)(p_data + i);
                //co_printf("NTF_NEGATIVE_ACT,len:%d\r\n",data_len);
                i+=2;
